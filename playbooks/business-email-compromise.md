...
Unlike standard phishing emails that are sent out indiscriminately to large numbers of email address, BEC attacks are usually crafted to specific individuals and can be harder to detect.
