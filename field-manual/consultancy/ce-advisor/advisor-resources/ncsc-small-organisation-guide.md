...
<table><thead><tr><th width="257.33331298828125">Recommendation</th><th>CE Requirement?</th></tr></thead><tbody><tr><td><strong>Enable MFA</strong></td><td><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement</strong>:</mark> Multi-Factor Authentication (MFA) must be enabled for all users accessing cloud services.<br><em>(<mark style="color:$info;">Maps to: User Access Control</mark>)</em></td></tr><tr><td><strong>Use a strong, separate password for your email</strong></td><td><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement:</strong></mark> Passwords must meet specific CE criteria (e.g., at least 8 characters long when combined with MFA or anti-guessing measures, or 12 characters minimum). Passwords cannot be shared across different services. <br><em>(<mark style="color:$info;">Maps to: User Access Control</mark>)</em></td></tr><tr><td><strong>Be cautious with what you share and send</strong></td><td><em>Not a CE Requirement.</em> CE does not formally assess user awareness or data loss prevention.</td></tr></tbody></table>
...
<table><thead><tr><th width="257.33331298828125">Recommendation</th><th>CE Requirement?</th></tr></thead><tbody><tr><td><strong>Enable MFA</strong></td><td><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement</strong>:</mark> Multi-Factor Authentication (MFA) must be enabled for all users accessing cloud services.<br><em>(<mark style="color:$info;">Maps to: User Access Control</mark>)</em></td></tr><tr><td><strong>Use a Password Manager</strong></td><td><p><em><mark style="color:$warning;">Best Practice (Helps pass CE):</mark></em> While not strictly required, CE encourages password managers because they help users comply with the strict CE rules of having long, unique passwords for every service without having to write them down securely.</p><p><em>(<mark style="color:$info;">Maps to: User Access Control</mark>)</em></p></td></tr><tr><td><strong>Create strong passwords using 3 random words</strong></td><td><em><mark style="color:$warning;">Best Practice (Helps pass CE):</mark></em> CE mandates minimum password lengths and complexity. The NCSC's "3 random words" strategy is their recommended way to help users generate passwords that exceed the CE 8-to-12 character minimums easily.<br><em>(<mark style="color:$info;">Maps to: User Access Control</mark>)</em></td></tr><tr><td><strong>Remove access for staff who have left or no longer need it</strong></td><td><p><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement:</strong></mark> You must have a process to create and approve accounts, and specifically, to remove or disable accounts when they are no longer required (e.g., when an employee leaves).</p><p><em>(<mark style="color:$info;">Maps to: User Access Control</mark>)</em></p></td></tr></tbody></table>
...
<table><thead><tr><th width="257.33331298828125">Recommendation</th><th width="466.66668701171875">CE Requirement?</th></tr></thead><tbody><tr><td><strong>Switch on your firewall</strong></td><td><p><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement</strong>:</mark> A software firewall must be enabled and configured on every in-scope device to protect it when it leaves the corporate network, alongside a boundary firewall for the office.</p><p><em>(<mark style="color:$info;">Maps to: Firewalls and Routers</mark>)</em></p></td></tr><tr><td><strong>Apply updates promptly (Turn on automatic updates)</strong></td><td><p><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement:</strong></mark> All software, apps, and operating systems must be kept up to date. Any "High" or "Critical" security updates must be applied within 14 days of release.</p><p><em>(<mark style="color:$info;">Maps to: Security Update Management</mark>)</em></p></td></tr><tr><td><strong>Use Antivirus / Anti-malware software</strong></td><td><p><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement:</strong></mark> Devices must be protected from malicious software. For most standard OSs (Windows/macOS), this means running updated anti-malware software (like Windows Defender) that scans files upon access.</p><p><em>(<mark style="color:$info;">Maps to: Malware Protection</mark>)</em></p></td></tr><tr><td><strong>Lock your devices (PIN, password, or biometrics)</strong></td><td><p><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement:</strong></mark> All in-scope devices must require a password, PIN, or biometric authentication to unlock them.</p><p><em>(<mark style="color:$info;">Maps to: User Access Control / Secure Configuration</mark>)</em></p></td></tr><tr><td><strong>Remove unused software and apps</strong></td><td><p><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <mark style="color:$danger;"><strong>CE Requirement:</strong></mark> Only approved software should be installed. Any unused applications or services must be removed or disabled to reduce the attack surface.</p><p><em>(<mark style="color:$info;">Maps to: Secure Configuration</mark>)</em></p></td></tr></tbody></table>
