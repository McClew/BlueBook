...
<table><thead><tr><th width="257.33331298828125">Recommendation</th><th>CE Requirement?</th></tr></thead><tbody><tr><td>Enable MFA</td><td><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <strong>CE Requirement</strong>: Multi-Factor Authentication (MFA) must be enabled for all users accessing cloud services.<br><em>(Maps to: User Access Control)</em></td></tr><tr><td>Use a strong, separate password for your email</td><td><i class="fa-siren-on" style="color:$danger;">:siren-on:</i> <strong>CE Requirement:</strong> Passwords must meet specific CE criteria (e.g., at least 8 characters long when combined with MFA or anti-guessing measures, or 12 characters minimum). <br>Passwords cannot be shared across different services. <br><em>(Maps to: User Access Control)</em></td></tr><tr><td></td><td></td></tr></tbody></table>
